...
class FreeLanceManager
{
    ...
    public function get_orders($code)
    {
        return $this->wpdb->get_results($this->getOrdersQuery($code));
    }

    private function getOrdersQuery($code)
    {
        $sql = " SELECT
                    wp_posts.ID,
                    wp_posts.post_title,
                ...
                WHERE
                    ...
                    AND wp_posts.post_excerpt LIKE '%$code%'
