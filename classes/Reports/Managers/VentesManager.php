...
class VentesManager
{
    ...
    private $show_all_categories = false;
    ...
    public function get_data($min, $max)
    {
        $data = [];
        ...
        foreach($results as $result)
        {
            ...
            if($this->show_all_categories == false)
            {
            ...
            //now work for the maximum and minimum values
            if($result->total > $max)
            {
                continue;
            }
